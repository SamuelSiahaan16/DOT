<x-adminLayout title="Kategori Barang">
    ...
    <div class="row">
        <div class="d-sm-flex align-items-center gap-6 pt-8 mb-7">
            <a href="{{ route('kategori.create') }}" class="btn d-block btn-primary px-5 py-8 mb-6 mb-sm-0">Tambah
                Kategori
                Barang</a>
        </div>
    </div>
        ...
        <div class="table-responsive mb-4">
            <table class="table border text-nowrap customize-table mb-0 align-middle">
                <thead class="text-dark fs-4">
                    <tr>
                        <th>
                            <h6 class="fs-4 fw-semibold mb-0">Nama Kategori Barang</h6>
                        </th>
                        <th></th>
                    </tr>
                </thead>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <li>
                                        <a class="dropdown-item d-flex align-items-center gap-3" href="javascript:;"
                                            onclick="handle_confirm('Apakah Anda Yakin?','Yakin','Tidak','POST','{{route('kategori.delete',$item->id)}}');"><i
